import { abi as IAriswapV3PoolABI } from '@ariswap/v3-core/artifacts/contracts/interfaces/IAriswapV3Pool.sol/IAriswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IAriswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IAriswapV3Pool, IAriswapV3Pool, IAriswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IAriswapV3PoolABI, wallet)) as [
      IAriswapV3Pool,
      IAriswapV3Pool,
      IAriswapV3Pool
    ]
  ...
  let pools: [IAriswapV3Pool, IAriswapV3Pool, IAriswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestAriswapV3Callee')
